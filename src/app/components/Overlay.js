...
const Overlay = ({
  ...
  mainOpacity = 0.30, // Opacity for main overlay
  leftOpacity = 0.60, // Opacity of left triangle
  rightOpacity = 0.60, // Opacity of right triangle
    ...
    <>
      ...
      <div
        ...
        style={{
          width: '100%',
          height: '100%',
          opacity: isAnimatingIn ? mainOpacity : isAnimatingOut ? 0 : mainOpacity, // Ensure opacity is set correctly
          transition: `opacity ${animationDuration}s ease`, // Use configurable animation duration
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          transition: `transform ${animationDuration}s ease`, // Use configurable animation duration
          transform: isAnimatingIn ? 'translateX(0)' : isAnimatingOut ? 'translateX(-150%)' : 'translateX(0)', // Ensure triangles remain visible
        }}
      />
